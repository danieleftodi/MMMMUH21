...
public:
    ...
    int deg2NodeCount(class Node *p);
    int deg2NodeCount()
    {
...
int Tree::deg2NodeCount(class Node *p)
{
    int x;
    int y;
...
int main() {
    ...
    cout << "Number of degree 2 nodes: " << bt.deg2NodeCount(T);
